...
interface InfoIconBannerProps {
  message: string;
}

export const InfoIconBanner: React.FC<InfoIconBannerProps> = ({ message }) => {
  return (
    <Banner variant="primary" icon={AlertCircle}>
      {message}
    </Banner>
  );
};

interface WarningIconBannerProps {
  message: string;
}

export const WarningIconbanner: React.FC<WarningIconBannerProps> = ({ message }) => {
  return (
...
interface EffectiveFromProps {
  message: string;
}

export const EffectiveFrom: React.FC<WarningIconBannerProps> = ({ message }) => {
  return (
    <Banner variant="info" icon={Bookmark}>
      {message}
    </Banner>
  );
};
